...
$(document).ready((function(){$(".block").on("click",(function(){$(".block").toggleClass(" block")})),$(".popup-link").magnificPopup({}),autosize(document.querySelectorAll("textarea")),$(".tabs").each((function(){let e=$(this);e.find(".tabs__item").not(":first").hide(),e.find(".tabs__link").click((function(){e.find(".tabs__link").removeClass("active").eq($(this).index()).addClass("active"),e.find(".tabs__item").hide().eq($(this).index()).fadeIn()})).eq(0).addClass("active")})),$(".spoiler__body").hide(300),$(document).on("click",".spoiler__head",(function(e){e.preventDefault(),$(this).parents(".spoiler").toggleClass("active").find(".spoiler__body").slideToggle()})),$(".example__slider").slick({slidesToShow:2,slidesToScroll:2,dots:!1,arrow:!1,appendArrows:$(".example__slider-arrows"),appendDots:$(".example__slider-dots"),prevArrow:'<button class="slick-prev example__slider-prev" aria-label="Previous" type="button"><img src="img/arrow-left.png"></button>',nextArrow:'<button class="slick-next example__slider-next" aria-label="Next" type="button"><img src="img/arrow-right.png"></button>',responsive:[{breakpoint:1210,settings:{slidesToShow:2}},{breakpoint:991,settings:{slidesToShow:2,dots:!0,arrow:!0}}]}),$(".__slider").slick({slidesToShow:2,slidesToScroll:2,dots:!1,arrow:!1,appendArrows:$(".__arrows"),appendDots:$(".__dots"),prevArrow:'<button class="slick-prev" aria-label="Previous" type="button"><img src="img/arrow-left.png"></button>',nextArrow:'<button class="slick-next" aria-label="Next" type="button"><img src="img/arrow-right.png"></button>'});let e="",t="";$(".select__head").on("click",(function(){$(this).next().toggleClass(" select__box--active"),$(this).toggleClass(" select__head--active")})),$(".select__item").on("click",(function(){e=$(this).children("span").text(),t=$(this).children("img").attr("src"),$(this).closest(".select__box").children(".select__item").removeClass("select__item--curent"),$(this).toggleClass("select__item--curent"),$(this).closest(".select__box").siblings(".select__head").toggleClass("select__head--active"),$(this).closest(".select__box").siblings(".select__head").children("span").html(e),$(this).closest(".select__box").toggleClass(" select__box--active"),$(this).closest(".select__box").siblings(".select__head").children(".select__chosed-icon").prop("src",t),$(this).closest(".select__box").siblings(".select__input").children("input").attr("value",e)}));let s=$("#myInput"),l=$("#myButton"),i=$("#myFiles"),n=[];s.change((function(){let e=[];for(let t=0;t<s[0].files.length;t++){let l=s[0].files[t];e.push(l),n.push(l)}$(".upload-has__delete").addClass("upload-has__delete--open"),e.forEach((e=>{let t=$(`<p>${e.name}</p>`);t.data("fileData",e),i.append(t),t.click((function(e){let t=$(e.target),s=n.indexOf(t.data("fileData"));t.remove(),n.splice(s,1)}))}))})),l.click((function(){s.click()})),$(".upload-has__delete").on("click",(function(){document.getElementById("myInput").value="",document.getElementById("myFiles").innerHTML="",$(".upload-has__delete").removeClass("upload-has__delete--open")})),$(".quantity_inner .bt_minus").click((function(){let e=$(this).parent().find(".quantity"),t=parseInt(e.val())-1;t=t<1?1:t,e.val(t)})),$(".quantity_inner .bt_plus").click((function(){let e=$(this).parent().find(".quantity"),t=parseInt(e.val())+1;t=t>parseInt(e.data("max-count"))?parseInt(e.data("max-count")):t,e.val(parseInt(t))}))}));